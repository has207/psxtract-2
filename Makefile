...
LIBS = -lkernel32 -luser32 -ladvapi32 -lmsacm32

SRCDIR = src
OBJDIR = obj

# Source files
CPP_SOURCES = $(SRCDIR)/psxtract.cpp $(SRCDIR)/crypto.cpp $(SRCDIR)/cdrom.cpp $(SRCDIR)/lz.cpp $(SRCDIR)/utils.cpp $(SRCDIR)/md5_data.cpp $(SRCDIR)/at3acm.cpp
